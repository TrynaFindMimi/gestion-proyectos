...
| **Objetivo del sprint** | Realizar pruebas funcionales, de rendimiento y responsividad; migrar el sitio a staging y luego a producción con SSL; elaborar la documentación; capacitar al personal del albergue y realizar la entrega formal |
...
|---|--------|------------------|
| 1 | Mariana del Arroyo | Coordinación, migración a staging y producción, coordinación con el hosting |
...
| 4 | Jorge Saenz | QA/Testing (rendimiento, responsividad), elaboración de manuales y capacitación |
...
| **E8** | Despliegue en producción con SSL | Sitio público operativo |
...
| 45–46 | Pruebas de rendimiento (PageSpeed, GTmetrix, Lighthouse) | WP Super Cache + Smush / EWWW | Jorge Saenz | Completada |
...
| 49–50 | Migración del sitio de local a staging en el hosting | All-in-One WP Migration | Mariana del Arroyo | Completada |
| 50–52 | Pruebas en staging (formularios, donaciones, adopciones) | — | Jorge Saenz | Completada |
| 52–53 | Configuración de SSL/TLS, dominio y DNS en producción | Really Simple SSL | Mariana del Arroyo | Completada |
| 53–54 | Migración final de staging a producción | All-in-One WP Migration | Mariana del Arroyo | Completada |
...
1. El hosting fue provisionado por el albergue el día 48 (dentro del plazo de la Semana 7); se entregó asistencia técnica para la contratación y se recibieron las credenciales de acceso.
2. El dominio se vinculó correctamente y el certificado SSL (Let's Encrypt) quedó activo en producción el día 53.
3. En las pruebas de rendimiento el sitio alcanzó un puntaje Lighthouse ≥ 90/100 en dispositivos móviles; se optimizaron las imágenes y se activó la caché.
...
- **E8**: Sitio desplegado en producción con SSL/TLS activo, dominio y DNS configurados; smoke test aprobado.
...
|------------------|------------------------|--------------------|
| Migraciones a staging y producción sin pérdida de datos | Documentar el procedimiento de despliegue para futuras réplicas | Incluir guía de despliegue en el Manual de Sistemas |
