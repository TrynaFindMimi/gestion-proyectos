...
| **Objetivo del sprint** | Contratar y configurar el plan de WordPress, seleccionar la plantilla, definir la colección "Animales" y construir el sitio base con landing, galería de animales y ficha individual |
...
|---|--------|------------------|
| 1 | Mariana del Arroyo | Coordinación, contratación del plan y configuración del sitio en WordPress |
...
| 1–3 | Contratación del plan WordPress y creación del sitio | WordPress (Premium) | Mariana del Arroyo | Completada |
| 3–5 | Selección y personalización de la plantilla (colores, logo del albergue) | Temas de WordPress | Nahomi Humerez | Completada |
| 3–5 | Configuración de marca y estructura de páginas | Editor drag & drop | Nahomi Humerez | Completada |
| 5–8 | Creación de la colección "Animales" con filtros (especie, tamaño, edad, estado) | Colecciones de WordPress | Santiago Acha | Completada |
...
| 12–14 | Página de galería de animales con filtros | Colecciones de WordPress | Nahomi Humerez | Completada |
...
2. El tema de WordPress generó un conflicto menor con un bloque de la landing en el editor; se resolvió ajustando la estructura del bloque y publicando la versión corregida.
...
- Sitio base configurado y navegable en el editor de WordPress con la plantilla personalizada.
