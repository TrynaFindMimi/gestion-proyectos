# BITÁCORA DE SPRINT 1 — CONFIGURACIÓN, DISEÑO Y ESTRUCTURA
...
| **Nombre del sprint** | Configuración, diseño y estructura |
| **Período** | Semanas 1–2 (Días 1 al 14) |
| **Fecha de inicio** | [dd/mm/aaaa] |
| **Fecha de cierre (demo)** | [dd/mm/aaaa] |
| **Objetivo del sprint** | Contratar y configurar el plan de Hostinger Web Builder, seleccionar la plantilla, definir la colección "Animales" y construir el sitio base con landing, galería de animales y ficha individual |
...
|---|--------|------------------|
| 1 | Mariana del Arroyo | Coordinación, contratación del plan y configuración del sitio en Hostinger Web Builder |
| 2 | Nahomi Humerez | Diseño de wireframes y mockups (Figma), landing page y galería |
| 3 | Santiago Acha | Configuración de la colección "Animales", filtros y páginas |
...
| 1–3 | Contratación del plan Web Builder de Hostinger y creación del sitio | Hostinger Web Builder (Premium) | Mariana del Arroyo | Completada |
| 3–5 | Selección y personalización de la plantilla (colores, logo del albergue) | Plantillas del constructor | Nahomi Humerez | Completada |
| 3–5 | Configuración de marca y estructura de páginas | Editor drag & drop | Nahomi Humerez | Completada |
| 5–8 | Creación de la colección "Animales" con filtros (especie, tamaño, edad, estado) | Colecciones del constructor | Santiago Acha | Completada |
...
| 9–12 | Construcción de landing page (hero, CTA, contador, animales destacados) | Editor drag & drop | Nahomi Humerez | Completada |
| 12–14 | Página de galería de animales con filtros | Colecciones del constructor | Nahomi Humerez | Completada |
| 12–14 | Página de ficha individual de animal (galería, datos, CTA de adopción) | Editor + bloques | Santiago Acha | Completada |
| 12–14 | Header, footer y menú de navegación global | Editor drag & drop | Nahomi Humerez | Completada |
| 13 | Página 404 personalizada | Editor | Jorge Saenz | Completada |
...
2. La plantilla del constructor generó un conflicto menor con un bloque de la landing en el editor; se resolvió ajustando la estructura del bloque y publicando la versión corregida.
...
- Sitio base configurado y navegable en el editor de Hostinger Web Builder con la plantilla personalizada.
...
| Trabajo paralelo de diseño y configuración sin conflictos | Documentar decisiones de configuración a medida que se toman | Registrar configuración en el Manual Técnico |
