...
| Tema | Tema base ligero (Astra/Kadence/GeneratePress) con tema hijo personalizado |
| Constructor visual | Gutenberg / Elementor |
| Plugins | CPT UI, ACF, WPForms/CF7, Yoast SEO, Wordfence, UpdraftPlus, WP Mail SMTP |
| Base de datos | MySQL / MariaDB |
| Almacenamiento de imágenes | Biblioteca de medios nativa de WordPress |
| Envío de correos | WP Mail SMTP |
| Despliegue | Migración mediante plugin (All-in-One WP Migration). Servidores/hosting proporcionados por la ONG. |
| Control de versiones | Git (GitHub) para tema y configuraciones |
| Entorno local | Local by Flywheel / XAMPP |
...
| Hosting, servidores, dominio y certificados SSL: **por cuenta del albergue**. Realizamos la configuración y personalización de WordPress en entorno local y migraremos el sitio a los servidores que el albergue proporcione. Si no cuenta con hosting propio, entregaremos **proformas con opciones de hosting WordPress** para que elija según su presupuesto. Como consultores brindaremos cotizaciones y asesoría, pero **no los proveeremos ni pagaremos**. Asimismo, **no nos comprometemos por la compra del dominio si su costo supera el presupuesto del proyecto**. La instalación de plugins premium con costo adicional requerirá aprobación previa del albergue. | ✅ |
...
- CMS WordPress con tema base ligero (Astra/Kadence/GeneratePress) y tema hijo personalizado.
- Constructor visual Gutenberg / Elementor para maquetación de páginas.
- Plugins para funcionalidades específicas: CPT UI + ACF, WPForms/CF7, Yoast SEO, Wordfence, UpdraftPlus, WP Mail SMTP.
